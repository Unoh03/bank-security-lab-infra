...
if ([regex]::Matches($managerWithIntegration, 'custom-shuffle-soc').Count -ne 1 -or
    ...
    $managerWithIntegration -notmatch '<rule_id>100110,100111</rule_id>') {
...
$badIntegration = $integrationFragment -replace '<rule_id>100110,100111</rule_id>', '<rule_id>100103</rule_id>'
