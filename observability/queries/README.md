...
| CAPITAL-ONE Karpenter Node Role S3 읽기 | `13_capital_one_validation_getobject.cwli` | `GetObject + Primary Karpenter Node Role + validation/*`의 성공·실패를 같은 시간축으로 수집한다. Runtime 검증은 새 통제 실습에서 수행 |
